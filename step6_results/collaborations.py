...
def collab_signed_ods(collab):
    ...
    tmp=(tmp.loc[(tmp.stage=='successful')&(~tmp.thema_code.isin(['ERC', 'MSCA']))&(tmp.status_code!='REJECTED')]
            ...
            'abstract', 'free_keywords', 
            'action_code', 'action_name', 'thema_code', 'destination_code',  'destination_name_en', 
            'part_num', 'coord_num', 'fund', 'part_num_collab', 'fund_collab', 'coord_num_collab', 'with_coord',
            'extra_joint_organization',
            'extra_joint_organization_collab',
            'country_code', 'country_name_en', 
            'country_group_association_code',
            'country_group_association_name_fr',
            'country_code_collab', 'country_name_en_collab',
            'country_group_association_code_collab',
            'country_group_association_name_fr_collab',
            'pilier_name_en', 'programme_name_en', 
            'thema_name_en', 'ecorda_date', 'programme_code', 'pilier_code',
...
def msca_collab_ods(collab):
    ...
    tmp=(tmp.loc[(collab.programme_code.isin(['HORIZON.1.2'])),
            ...
            'part_num', 'coord_num', 'part_num_collab', 'coord_num_collab', 'fund', 'fund_collab',
...
def msca_collab(collab):
    ...
    msca_collab = (collab.loc[collab.programme_code.isin(['HORIZON.1.2']),
        ...
        'country_code_collab', 'extra_joint_organization',
        'part_num', 'coord_num', 'coord_num_collab',  'with_coord', 'extra_joint_organization_collab',
        'part_num_collab', 'fund', 'fund_collab', 'stage', 'status_code',
        'country_name_en', 'country_group_association_code',
        ...
        'destination_name_en', 'destination_detail_code','destination_detail_name_en']])
