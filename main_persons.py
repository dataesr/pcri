...
from paths import PATH_CLEAN, PATH_HARVEST, PATH_WORK
...
lvar=['contact2','orcid_id','country_code', 'iso2', 'destination_code', 'operateur_num', 'nationality_country_code']
...
# request OPENALEX
affiliations(df, PATH_PERSONS, CSV_PERSONS)
