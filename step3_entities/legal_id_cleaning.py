...
def legal_id_clean(entities_tmp):
    # ACTEURS
    # nettoyage id
    test= entities_tmp[entities_tmp['countryCode_parent']=='FRA'][['generalPic', 'legalName', 'vat', 'legalRegNumber']].drop_duplicates()
...
def entities_link(entities_tmp):
    entitiesLinks = unzip_zip(ZIPNAME, f"{PATH_SOURCE}{FRAMEWORK}/", 'legalEntitiesLinks.json')
