...
def get_paysage(lid_source, siren_siret, paysage_old=None):
    ...
    def ID_to_IDpaysage(lid_source, siren_siret):
        ...
        print(f"nombre d'identifiants de entities à paysager {len(paysage_liste)}")
...
################################################
    ...
    def check_var_null(paysage):
        for i in ['category_id', 'cj_code', 'cj_name', 'sector', 'name_clean', 'acronym_clean']:
